 ...
 * limitations under the License.
 */
var module=angular.module("editor.drive",["editor.gapi"]);module.service("drive",["$q","$cacheFactory","googleApi","applicationId",function(e,t,n,i){var o="id,title,mimeType,userPermission,editable,copyable,shared,fileSize",l=t("files"),r=function(e,t){var n={metadata:e,content:t};return l.put(e.id,n),n};this.loadFile=function(t){var i=l.get(t);return i?e.when(i):n.then(function(n){var i=n.client.drive.files.get({fileId:t}),l=n.client.drive.files.get({fileId:t,alt:"media"});return e.all([e.when(i),e.when(l)])}).then(function(e){return r(e[0].result,e[1].body)})},this.saveFile=function(t,i){return n.then(function(n){var l,r;t.id?(l="/upload/drive/v2/files/"+encodeURIComponent(t.id),r="PUT"):(l="/upload/drive/v2/files",r="POST");var a=(new MultiPartBuilder).append("application/json",JSON.stringify(t)).append(t.mimeType,i).finish(),d=n.client.request({path:l,method:r,params:{uploadType:"multipart",fields:o},headers:{"Content-Type":a.type},body:a.body});return e.when(d)}).then(function(e){return r(e.result,i)})},this.showPicker=function(){return n.then(function(t){var n=e.defer(),o=new google.picker.View(google.picker.ViewId.DOCS_IMAGES);o.setMimeTypes("image/jpeg");var l=(new google.picker.PickerBuilder).setAppId(i).setOAuthToken(t.auth.getToken().access_token).addView(o).setCallback(function(e){if("picked"==e.action){var t=e.docs[0].id;n.resolve(t)}else"cancel"==e.action&&n.reject()}).build();return l.setVisible(!0),n.promise})},this.showSharing=function(e){return n.then(function(t){var n=new t.drive.share.ShareClient(i);n.setItemIds([e]),n.showSettingsDialog()})}}]),/*
 * Copyright 2015 Google Inc. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
